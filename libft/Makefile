...
ft_strjoin.c	ft_itoa.c	ft_atod.c	ft_substr.c \
ft_strtrim.c	ft_split.c	ft_striteri.c	ft_strmapi.c \
ft_free_split.c	ft_putchar_fd.c	ft_putstr_fd.c	ft_putendl_fd.c\
ft_putnbr_fd.c	get_next_line.c	ft_putnbr_u.c	ft_printf.c \
...
ft_lstsize_bonus.c	gnl_gc.c ft_join_array_of_pointers.c ft_uitoa_base.c
